...
namespace AutoUpdater
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        File.Delete(a);
            //    }
            //    arr = Directory.GetDirectories("./update");
            //    foreach(string dir in arr)
            //    {
            //        var g = dir.Substring(dir.IndexOf("./update\\") + "./update\\".Length);
            //        Directory.CreateDirectory("./" + g);
            //        foreach (string a in Directory.GetFiles(dir))
            //        {
            //            int u = a.IndexOf(dir + @"\") + (dir + @"\").Length;
            //            string x = a.Substring(u);
            //            File.Copy(a, "./" + g + "/" +  x);
            //            System.Threading.Thread.Sleep(100);
            //            File.Delete(a);
            ...
            //            File.Delete(s);
            //        }
            //        foreach(string dir in Directory.GetDirectories("./update"))
            //        {
            //            foreach (string a in Directory.GetFiles(dir))
            //                File.Delete(a);
            //            Directory.Delete(dir);
